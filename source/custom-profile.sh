...
if [[ $TEMP -eq 46 ]]; then DUTY=20; fi
if [[ $TEMP -eq 47 ]]; then DUTY=20; fi
if [[ $TEMP -eq 48 ]]; then DUTY=20; fi
if [[ $TEMP -eq 49 ]]; then DUTY=20; fi
if [[ $TEMP -eq 50 ]]; then DUTY=20; fi
if [[ $TEMP -eq 51 ]]; then DUTY=20; fi
if [[ $TEMP -eq 52 ]]; then DUTY=23; fi
if [[ $TEMP -eq 53 ]]; then DUTY=23; fi
if [[ $TEMP -eq 54 ]]; then DUTY=26; fi
if [[ $TEMP -eq 55 ]]; then DUTY=26; fi
if [[ $TEMP -eq 56 ]]; then DUTY=26; fi
if [[ $TEMP -eq 57 ]]; then DUTY=30; fi
if [[ $TEMP -eq 58 ]]; then DUTY=30; fi
if [[ $TEMP -eq 59 ]]; then DUTY=30; fi
if [[ $TEMP -eq 60 ]]; then DUTY=33; fi
if [[ $TEMP -eq 61 ]]; then DUTY=33; fi
if [[ $TEMP -eq 62 ]]; then DUTY=33; fi
if [[ $TEMP -eq 63 ]]; then DUTY=35; fi
if [[ $TEMP -eq 64 ]]; then DUTY=35; fi
if [[ $TEMP -eq 65 ]]; then DUTY=38; fi
if [[ $TEMP -eq 66 ]]; then DUTY=40; fi
if [[ $TEMP -eq 67 ]]; then DUTY=42; fi
if [[ $TEMP -eq 68 ]]; then DUTY=45; fi
if [[ $TEMP -eq 69 ]]; then DUTY=47; fi
if [[ $TEMP -eq 70 ]]; then DUTY=50; fi
if [[ $TEMP -eq 71 ]]; then DUTY=50; fi
if [[ $TEMP -eq 72 ]]; then DUTY=52; fi
if [[ $TEMP -eq 73 ]]; then DUTY=53; fi
if [[ $TEMP -eq 74 ]]; then DUTY=53; fi
if [[ $TEMP -eq 75 ]]; then DUTY=57; fi
if [[ $TEMP -eq 76 ]]; then DUTY=57; fi
if [[ $TEMP -eq 77 ]]; then DUTY=60; fi
if [[ $TEMP -eq 78 ]]; then DUTY=60; fi
if [[ $TEMP -eq 79 ]]; then DUTY=63; fi
if [[ $TEMP -eq 80 ]]; then DUTY=65; fi
if [[ $TEMP -eq 81 ]]; then DUTY=65; fi
if [[ $TEMP -eq 82 ]]; then DUTY=70; fi
if [[ $TEMP -eq 83 ]]; then DUTY=70; fi
if [[ $TEMP -eq 84 ]]; then DUTY=75; fi
if [[ $TEMP -eq 85 ]]; then DUTY=75; fi
if [[ $TEMP -eq 86 ]]; then DUTY=80; fi
if [[ $TEMP -eq 87 ]]; then DUTY=80; fi
if [[ $TEMP -eq 88 ]]; then DUTY=85; fi
if [[ $TEMP -eq 89 ]]; then DUTY=90; fi
if [[ $TEMP -eq 90 ]]; then DUTY=90; fi
...
if [[ $GPU -eq 40 ]]; then GDUTY=0; fi
if [[ $GPU -eq 41 ]]; then GDUTY=0; fi
if [[ $GPU -eq 42 ]]; then GDUTY=0; fi
if [[ $GPU -eq 43 ]]; then GDUTY=0; fi
if [[ $GPU -eq 44 ]]; then GDUTY=0; fi
if [[ $GPU -eq 45 ]]; then GDUTY=0; fi
if [[ $GPU -eq 46 ]]; then GDUTY=20; fi
if [[ $GPU -eq 47 ]]; then GDUTY=20; fi
if [[ $GPU -eq 48 ]]; then GDUTY=20; fi
if [[ $GPU -eq 49 ]]; then GDUTY=20; fi
if [[ $GPU -eq 50 ]]; then GDUTY=20; fi
if [[ $GPU -eq 51 ]]; then GDUTY=20; fi
if [[ $GPU -eq 52 ]]; then GDUTY=23; fi
if [[ $GPU -eq 53 ]]; then GDUTY=23; fi
if [[ $GPU -eq 54 ]]; then GDUTY=26; fi
if [[ $GPU -eq 55 ]]; then GDUTY=26; fi
if [[ $GPU -eq 56 ]]; then GDUTY=26; fi
if [[ $GPU -eq 57 ]]; then GDUTY=30; fi
if [[ $GPU -eq 58 ]]; then GDUTY=30; fi
if [[ $GPU -eq 59 ]]; then GDUTY=30; fi
if [[ $GPU -eq 60 ]]; then GDUTY=33; fi
if [[ $GPU -eq 61 ]]; then GDUTY=33; fi
if [[ $GPU -eq 62 ]]; then GDUTY=33; fi
if [[ $GPU -eq 63 ]]; then GDUTY=35; fi
if [[ $GPU -eq 64 ]]; then GDUTY=35; fi
if [[ $GPU -eq 65 ]]; then GDUTY=38; fi
if [[ $GPU -eq 66 ]]; then GDUTY=40; fi
if [[ $GPU -eq 67 ]]; then GDUTY=42; fi
if [[ $GPU -eq 68 ]]; then GDUTY=45; fi
if [[ $GPU -eq 69 ]]; then GDUTY=47; fi
if [[ $GPU -eq 70 ]]; then GDUTY=50; fi
if [[ $GPU -eq 71 ]]; then GDUTY=50; fi
if [[ $GPU -eq 72 ]]; then GDUTY=52; fi
if [[ $GPU -eq 73 ]]; then GDUTY=53; fi
if [[ $GPU -eq 74 ]]; then GDUTY=53; fi
if [[ $GPU -eq 75 ]]; then GDUTY=57; fi
if [[ $GPU -eq 76 ]]; then GDUTY=57; fi
if [[ $GPU -eq 77 ]]; then GDUTY=60; fi
if [[ $GPU -eq 78 ]]; then GDUTY=60; fi
if [[ $GPU -eq 79 ]]; then GDUTY=63; fi
if [[ $GPU -eq 80 ]]; then GDUTY=65; fi
if [[ $GPU -eq 81 ]]; then GDUTY=65; fi
if [[ $GPU -eq 82 ]]; then GDUTY=70; fi
if [[ $GPU -eq 83 ]]; then GDUTY=70; fi
if [[ $GPU -eq 84 ]]; then GDUTY=70; fi
if [[ $GPU -eq 85 ]]; then GDUTY=75; fi
if [[ $GPU -eq 86 ]]; then GDUTY=75; fi
if [[ $GPU -eq 87 ]]; then GDUTY=80; fi
if [[ $GPU -eq 88 ]]; then GDUTY=80; fi
if [[ $GPU -eq 89 ]]; then GDUTY=90; fi
if [[ $GPU -eq 90 ]]; then GDUTY=90; fi
